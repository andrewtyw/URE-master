...
# first, unannotate this to get the optimal threshold(it should be 0.9379379379379379)
...
then
    ...
    python -u ${METHOD}.py --seed ${SEED} \
                ...
                --train_path ${PROJECT_PATH}"/data/tac/annotated/tac_train.pkl" \
...
cd ${PROJECT_PATH}"/URE_mnli/relation_classification"

# unannotate this to get the optimal threshold of a finetuned MNLI(it should be 0.998998998998999)
# python -u run_evaluation.py --seed ${SEED} \
#                             --cuda_index ${CUDA_INDEX} \
#                             --dataset ${DATASET}  \
#                             --mode "0.01dev" \
#                             --get_optimal_threshold True 
#                             --load_dict True  \
#                             --dict_path ${PROJECT_PATH}"/data/save_model/tac_n"${RATIO}"train.pt"
